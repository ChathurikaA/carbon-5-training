 ...
 */
@Component(
        name = "org.wso2.carbon.sample.transport.file.HttpTransportServiceCapabilityProvider",
        immediate = true,
        property = "capabilityName=org.wso2.carbon.sample.transport.mgt.Transport"
)
public class HttpTransportServiceCapabilityProvider implements CapabilityProvider {
