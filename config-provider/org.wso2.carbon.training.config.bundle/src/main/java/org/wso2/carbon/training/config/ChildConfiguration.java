...
/**
 * A second level configuration bean class for example config.
 *
 */
@Configuration(description = "A second level configuration bean")
public class ChildConfiguration {
    ...
    public String toString() {
        return "destination : " + destination + ", isEnabled : " + isEnabled;
    }
}
